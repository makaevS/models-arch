...
import { ChangeMethods, CreateMethods, Internals } from ".";
import { createSelect, Select, SelectDefault } from "./select";
...
type PeriodFormDefaultParams = {
  periodTypeDefault: SelectDefault<SelectOption<PeriodTypes>>,
  periodDefault: SelectDefault<SelectOption<string>>
}
